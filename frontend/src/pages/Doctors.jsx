...
const Doctors = () => {
  ...
  return (
    <div className=" px-17 py-5 pb-50">
      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        <div className="flex flex-col gap-4 text-sm text-gray-600">
          <p
            ...
            className={`w-[96vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${
        ...
        <div
          ...
          className="w-full gap-4 gap-y-6"
        >
